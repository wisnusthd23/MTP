	...
	<div class="card card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea name="komposisi" class="form-control" rows="5" placeholder="Deskripsi Barang"><?= set_value('komposisi') ?></textarea>
			</div>
			<div class="form-group">
				<label>Manfaat Barang</label>
				<textarea name="manfaat" class="form-control" rows="5" placeholder="Deskripsi Barang"><?= set_value('manfaat') ?></textarea>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
